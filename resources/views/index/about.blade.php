...
@section('content')
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="{{ url('public/user/images/about-img.jpg')}}" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row my-4">
                ...
                <div class="featured-products-box owl-carousel owl-theme">
                    ...
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{ url('public/user/images/img-1.jpg')}}" alt="" />
             ...
             <div class="item">
                    ...
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{ url('public/user/images/img-2.jpg')}}" alt="" />
                            <div class="team-content">
             ...
             <div class="item">
                    ...
                    <div class="hover-team">
                        <div class="our-team"> <img src="{{ url('public/user/images/img-3.jpg')}}" alt="" />
                            <div class="team-content">
