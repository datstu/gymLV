...
<head>
	...
	<link href="{{asset('public/lumino/css/font-awesome.min.css')}}" rel="stylesheet">
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="panels.html"><em class="fa fa-clone">&nbsp;</em> QL Gói Tập</a></li>
			<li><a href="panels.html"><em class="fa fa-clone">&nbsp;</em> QL Sản phẩm</a></li>
			<li><a href="panels.html"><em class="fa fa-clone">&nbsp;</em> Level Khách Hàng</a></li>
			<li><a href="panels.html"><em class="fa fa-clone">&nbsp;</em> Hóa Đơn</a></li>
				<li><a href="panels.html"><em class="fa fa-clone">&nbsp;</em> Trạng thái</a></li>
	...
	<script src="{{asset('public/lumino/js/easypiechart.js')}}"></script>
	<script src="{{asset('public/lumino/js/easypiechart-data.js')}}"></script>
	<script src="{{asset('public/lumino/js/bootstrap-datepicker.js')}}"></script>
	<script src="{{asset('public/lumino/js/custom.js')}}"></script>
	<script>
