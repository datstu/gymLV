...
<head>
	...
	<!-- Font-->
	<link rel="stylesheet" type="text/css" href="{{ url('public/user_config/css/opensans-font.css')}}">
	<link rel="stylesheet" type="text/css" href="{{ url('public/user_config/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css')}}">
	<!-- Main Style Css -->
    <link rel="stylesheet" href="{{ url('public/user_config/css/style.css')}}"/>
</head>
<body>
									...
									<div class="form-row">
				                		<div class="form-holder form-holder-2 form-holder-3">
				                			...
				                			<label class="bank-images label-above bank-1-label" for="bank-1">
				                				<img src="{{ url('public/user_config/images/form-v1-1.png')}}" alt="bank-1">
				                			</label>
											...
											<label class="bank-images label-above bank-2-label" for="bank-2">
												<img src="{{ url('public/user_config/images/form-v1-2.png')}}" alt="bank-2">
											</label>
											...
											<label class="bank-images label-above bank-3-label" for="bank-3">
												<img src="{{ url('public/user_config/images/form-v1-3.png')}}" alt="bank-3">
											</label>
				                		</div>
				                	</div>
				                	<div class="form-row">
	...
	<script src="{{ url('public/user_config/js/jquery-3.3.1.min.js')}}"></script>
	<script src="{{ url('public/user_config/js/jquery.steps.js')}}"></script>
	<script src="{{ url('public/user_config/js/main.js')}}"></script>
