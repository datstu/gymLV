...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 30, 2020 lúc 12:14 PM
...
(57, 43241264, 1, 'ca1', 'ca1', 'ca1', 'ca1', 'ca1', 'ca1', 'null', 57, '2020-08-26');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_schedule_pt`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_schedule_pt`
--
...
INSERT INTO `tbl_visitor` (`id_visit`, `id_session`, `date`, `viewNumber`) VALUES
(1, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 2),
(2, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 2),
(3, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 2),
(4, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 2),
(5, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 20000),
(6, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 30000),
(7, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 3),
(8, '5pu9rnngv6ipsa8fp5rvqok1aq', '2020-08-30', 1);
...
--
-- Chỉ mục cho bảng `tbl_schedule_pt`
--
...
--
ALTER TABLE `tbl_schedule`
  MODIFY `id_schedule` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT cho bảng `tbl_schedule_pt`
--
ALTER TABLE `tbl_schedule_pt`
