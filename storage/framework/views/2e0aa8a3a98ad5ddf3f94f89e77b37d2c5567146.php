                    ...
                    <div class="right-product-box">
                        ...
                        <div class="product-categorie-box">
                            <div class="tab-content">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                         <ul class="nav nav-tabs ml-auto">
                                                            <li>
                                                                 <a class="nav-link" href="#list<?php echo e($sp->id_combo); ?>" data-toggle="tab" data-placement="right" title="View"> <i class="fas fa-eye"></i></a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="why-text">
                                                    <ul class="nav nav-tabs ml-auto">
                                                      <li>
                                                          <a class="nav-link" href="#list<?php echo e($sp->id_combo); ?>" data-toggle="tab"><h4><?php echo e($sp->ten); ?></h4> </a>
                                                      </li>
                                                    </ul>
                                                      </a>
                                ...
                                <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div role="tabpanel" class="tab-pane fade" id="list<?php echo e($sp->id_combo); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a class="btn hvr-hover" href="<?php echo e(route('thanhtoanGT',$sp->id_combo)); ?>">Đăng ký</a>
				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-GOI-TAP-left">
                    <div class="product-categori">
                        <div class="search-product">
                            <form action="<?php echo e(URL::to('/SEARCH-GT')); ?>" >
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                               ...
                               <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action <?php echo e($active3); ?>" href="#sub-men2" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men2" >Gói tập <small class="text-muted">(100)</small>
                                </a>
...
<?php echo $__env->make('template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/index/goitap.blade.php ENDPATH**/ ?>