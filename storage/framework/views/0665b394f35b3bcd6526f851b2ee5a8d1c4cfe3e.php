            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <?php endif; ?>
                        ...
                        <form class="form-horizontal" action="<?php echo e(url('/cap-nhat-goi-tap')); ?>" id="frmAddUser"  method="post" >
                            <fieldset>
                                <!-- Name input-->
                                ...
                                <?php echo csrf_field(); ?>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="name" name="name" type="text" value="<?php echo e($CB->ten); ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="name">Mô tả</label>
                                    <div class="col-md-9">
                                        <textarea rows="4"  id="name" name="descript" type="text"  class="form-control"><?php echo e($CB->description); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="name" name="price" type="text" value="<?php echo e($CB->price); ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="name">Thời gian</label>
                                    <div class="col-md-2">
                                        <input id="name" name="date" type="text" value="<?php echo e($CB->date); ?>" class="form-control"> 
                                    </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="phone" name="id_pt" type="hidden" value="<?php echo e($CB->id_combo); ?>" class="form-control" >
                                    </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/admin/comboGym/updateCB.blade.php ENDPATH**/ ?>