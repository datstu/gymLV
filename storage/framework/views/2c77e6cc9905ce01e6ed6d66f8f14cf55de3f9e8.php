            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <?php endif; ?>
                        ...
                        <form class="form-horizontal" id="frmAddUser" action="<?php echo e(url('/them-san-pham')); ?>" method="post" enctype="multipart/form-data">
                            <fieldset>
                                <!-- Name input-->
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/admin/product/addPD.blade.php ENDPATH**/ ?>