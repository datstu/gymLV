...
function F1(price)
{
            ...
            $("#priceShipping").html(prices);
             ...
             $("#totalPrice").html('');
             var product_price=<?php echo e($totalPrice+10000); ?>;
                    ...
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" action="<?php echo e(route('inhoadon')); ?>" method="get">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address"  name="address" value="<?php echo e($thongtin['address']); ?>" pattern="{1,50}" required> </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                ...
                                <div class="d-flex gr-total">
                                    <h5>Grand Total</h5>
                                    <div class="ml-auto h5" id="totalPrice"> $ <?php echo e(number_format($totalPrice+10000)); ?> </div>
                                </div>
                                 <input type="hidden" id="totalPriceinput"  name="totalPrice" value="<?php echo e($totalPrice+10000); ?>">
                                <hr> </div>
                        </div>
...
<?php echo $__env->make('template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/index/thanhtoan.blade.php ENDPATH**/ ?>