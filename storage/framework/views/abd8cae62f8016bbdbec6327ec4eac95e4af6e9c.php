        ...
        <div class="container">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box <?php echo e($ac1); ?>" id="formLogin" action="<?php echo e(route('dangnhap')); ?>" method="post" >
                       ...
                       <a href="<?php echo e(route('dangnhapgg')); ?>" class="btn btn-block btn-primary">
...
<?php echo $__env->make('template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/index/account.blade.php ENDPATH**/ ?>