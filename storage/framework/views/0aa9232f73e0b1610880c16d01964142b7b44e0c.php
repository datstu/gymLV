            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="table-main table-responsive collapse show">
                        <table class="table">
                            <thead>
                                <form action=" <?php echo e(route('sualich')); ?>

                                " method="get">
                                    <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="id_gym" value="<?php echo e($phonggym->id_gym); ?>">
                                <input type="text" name="id_gt" value="<?php echo e($gt); ?>">
                                <input type="text" name="id_schedule" value="<?php echo e($phonggym->id_schedule); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <?php $s = 'thu'.$i; ?>
                             <td>
                                <input  type="radio" name="t<?php echo e($i); ?>" id="ca1_t<?php echo e($i); ?>" 
                                <?php 
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <?php else: ?>  <?php $s = 'thu'.$i; ?>
                             <td>
                                <input type="radio" name="t<?php echo e($i); ?>" id="ca2_t<?php echo e($i); ?>"
                                <?php 
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <?php else: ?>  <?php $s = 'thu'.$i; ?>
                             <td>
                                <input type="radio" name="t<?php echo e($i); ?>" id="ca3_t<?php echo e($i); ?>"
                                <?php 
...
<?php echo $__env->make('template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvanchinh\gymLV\resources\views/index/update_book.blade.php ENDPATH**/ ?>